...
function AddAdmin() {
    ...
    const createUser = async () => {
        try {
            ...
            // Insert user email into admins table
    ...
    return (
        <div className='flex flex-col items-center justify-center mt-20'>
            <div className='border-2 border-primary rounded-2xl px-10 py-12 shadow-2xl'>
                <h1 className='text-4xl font-judul hover:font-mono'>Menambah Admin</h1>
                ...
                <button className="btn btn-outline btn-secondary mt-8 w-full" onClick={createUser}>Buat Admin</button>
            </div>
        </div>
    );
}
